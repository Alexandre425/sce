...
struct command_d
{
	...
	{cmd_comm_define_alarm_clock, 		"dac", ""},
	{cmd_comm_define_temp_lum, 			"dtl", ""},
	{cmd_comm_activate_alarms, 			"aa", ""},
	{cmd_comm_info_reg, 				"ir", ""},
	{cmd_comm_transfer_reg, 			"trc", ""},
	{cmd_comm_transfer_reg_from, 		"tri", ""},
	{cmd_local_info_local_reg, 			"irl", ""},
	{cmd_local_list_reg, 				"lr", ""},
	{cmd_local_delete_reg, 				"dr", ""},
	{cmd_proc_check_period_transfer, 	"cpt", ""},
	{cmd_proc_mod_period_tranfer, 		"mpt", ""},
	{cmd_proc_check_thresh_temp_lum, 	"cttl", ""},
	{cmd_proc_define_thresh_temp_lum, 	"dttl", ""},
	{cmd_proc_process_reg, 				"pr", ""}
	};
